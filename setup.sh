...
echo ''
echo "                                                              "
echo -e "$Lyellow                ⚡    MEDUSA AUTOSCIPT ⚡"$NC
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By @medusa_cha"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @mpcstore"$NC
echo -e "$green.........................................................."$NC
echo ''
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/access/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You are Allowed to use AUTOSCRIPT medusa..\e[0m"
        sleep 5
    else
...
IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/access/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
echo -e "\e[1;32m══════════════════ Autoscript By medusa ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|        PREMIUM BY medusa      |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
